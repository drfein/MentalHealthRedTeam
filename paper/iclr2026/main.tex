...
The framing-aware direct-assertion rate is also descriptively highest within each released source stratum (Appendix Table~\ref{tab:source-behavior}). The WildChat and ShareChat--Grok strata are small, so this check establishes directional consistency rather than source-specific effect estimates.
