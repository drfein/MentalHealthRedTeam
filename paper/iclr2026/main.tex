...
\begin{enumerate}
    ...
    \item \textbf{A controlled interpretability case study.} Jacobian-lens epistemic readouts predict endorsement-prone items beyond measured covariates and predefined lexical placebos, while randomized and hard-negative controls rule out stronger claims about causal gating or genuine user belief.
\end{enumerate}
