...
source-stratified descriptive rates, endpoint overlap, and frozen analysis
settings. Exploratory interpretability artifacts are not part of the submission
evidence bundle.
